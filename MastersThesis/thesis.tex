...
сверхчувствительных фотодиодов \cite{semicondNNW2006}, транзисторов сверхвысокой плотности [статья про это], эмиттеров излучения видимого диапазона волн [статья про это] и ТГц диапазона [статья В.Н.].\par
Решающую роль 
