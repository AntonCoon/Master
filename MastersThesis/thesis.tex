...
Огромная перспективность обусловлена рядом исключительных свойств таких нанообъектов и структур на их основе. Характерные размеры, порядка $100 \text{ нм}$ в диаметре и $1 \text{ мкм}$ по высоте приводят к огромным, по сравнению с объемными материалами, отношениям площади поверхности к объему. Такая особенность в первую очередь влияет на рекомбинационные свойства материала, так как существенно увеличивается поверхностная рекомбинация. Кроме того, для некоторых материалов, таких как $GaAs$ $n$ типа, при концентрации порядка $10^{-15} \text{ см}^{-3}$ и небольших диаметрах происходит полное обеднение объема ННК. Это в свою очередь приводит к изменению энергетических уровней в полупроводнике.
	...
	\begin{thebibliography}{9}
		...
		\bibitem{THzGeneration} Trukhin V. N. et al. Terahertz generation by GaAs nanowires //Applied Physics Letters. – 2013. – Т. 103. – №. 7. – С. 072108.
	\end{thebibliography}		
	\newpage
